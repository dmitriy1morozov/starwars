...
public class Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  private final Holder.OnItemClickListener mOnItemClickListener;

  Adapter(Context context, ArrayList<Person> characters, Holder.OnItemClickListener onItemClickListener) {
    mContext = context;
